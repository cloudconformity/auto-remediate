...
module.exports.handler = (event, context, callback) => {
	console.log(
		"Lambda Function Tracing Enabled - Received event:",
	...
	return Lambda.getFunctionConfiguration({ FunctionName: FunctionName })
		.promise()
		.then(function (data) {
			...
			return IAM.attachRolePolicy(AttachRolePolicyParams)
				...
				.then(function () {
					console.log(
						"Successfully attached AWSXray managed policy to the function role"
					);
					...
					return new Promise(function (resolve) {
						...
						.then(function () {
							...
							return Lambda.updateFunctionConfiguration(FunctionConfigurationParams)
								.promise()
								.then(function () {
									return callback(
										null,
										"Successfully updated function configuration"
									);
								});
						})
						.catch(function (err) {
							...
							return handleError(
								err.message
									? err.message
									: "Failed to enable tracing for the function"
							);
						});
				});
		});
