...
const source = require('../functions/AutoRemediateS3-006');
var AWS = require('aws-sdk-mock');

const sampleEvent = {
    id: "ccc:HJzFMHchx:S3-006:S3:ap-southeast-2:sample-bucket",
    organisationId: "some-organisation",
    accountId: "abcdef",
    ruleId: "S3-006",
    ruleTitle: "S3 Bucket Authenticated Users 'READ' Access",
    service: "S3",
    ...
    message: "Bucket sample-bucket allows  authenticated users READ access.",
...
describe('S3-006 AutoRemediation', () => {
    ...
    describe('valid invocation', () => {
        ...
        it('should remove READ grants for Authenticated Users', () => {
            expect(putBucketAclMock).not.toHaveBeenCalledWith(expect.objectContaining(grantReadAuthenticatedUsers), expect.any(Function))
        })
